## Slick2 generic application [![Build Status](https://travis-ci.org/nmartynenko/slick2-generic-example.png?branch=master)](https://travis-ci.org/nmartynenko/slick2-generic-example)
